...
int main(int argc, char* argv[])
{
  try
  {
    ...
    if (argc != 10)
    {
      std::cerr << "Usage: ssl_client <address> <port> <io_pool_size> <thread_pool_size> <preallocated_handler_number> <data_buffer_size> <timeout_seconds> <closed_wait> <connection_number>\n";
      std::cerr << "  For IPv4, try:\n";
      std::cerr << "    ssl_client 0.0.0.0 1000 4 4 500 64 0 5 100\n";
      std::cerr << "  For IPv6, try:\n";
      std::cerr << "    ssl_client 0::0 1000 4 4 500 64 0 5 100\n";
      return 1;
    }
